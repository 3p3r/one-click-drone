...
class Stack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    const networking = new Networking(this);
    ...
    const dbSubnetGroup = new rds.CfnDBSubnetGroup(this, 'DBSubnetGroup', {
      ...
      subnetIds: networking.vpc.privateSubnets.map(subnet => subnet.subnetId),
    });
    ...
    cluster.node.applyAspect(new InjectEfsIntoContainerInstance(cacheVolume.ref));
