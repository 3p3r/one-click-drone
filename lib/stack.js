...
class Stack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    new cdk.CfnOutput(this, 'DroneHomepage', {
      description: [
        'This is the homepage of your Drone CI deployment.',
        'You should set this in your Github OAuth apps page: https://github.com/settings/developers.',
        'If you specified a custom domain for Drone,',
        'you must manually provision a certificate for it in the "us-east-1" (N. Virginia) region',
        'and follow https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/cnames-and-https-procedures.html',
    ...
    new cdk.CfnOutput(this, 'OAuthCallback', {
      description: [
        'This is the OAuth callback of your Drone CI deployment.',
        'You should set this in your Github OAuth apps page: https://github.com/settings/developers.',
      ].join(' '),
    ...
    new cdk.CfnOutput(this, 'CloudFrontURI', {
      description: [
        'This is the autogenerated CloudFront domain name.',
        'If you specified a custom domain for Drone,',
